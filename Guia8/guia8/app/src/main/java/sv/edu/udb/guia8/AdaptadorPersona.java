...
public class AdaptadorPersona extends ArrayAdapter<Persona> {
    ...
    public View getView(int position, @Nullable View view, @NonNull ViewGroup parent) {
        ...
        TextView fecha_nac=rowview.findViewById(R.id.txt_fecha_nac);
        TextView genero=rowview.findViewById(R.id.txt_genero);
        TextView peso=rowview.findViewById(R.id.txt_weight);
        TextView altura=rowview.findViewById(R.id.txt_heigth);

        tvNombre.setText("Nombre : "+personas.get(position).getNombre());
        tvDUI.setText("DUI : " + personas.get(position).getDui());

        fecha_nac.setText("Fecha de nacimiento : " + personas.get(position).getBirthdate());

        genero.setText("Genero: "+personas.get(position).getGenero());

        peso.setText("Peso: "+personas.get(position).getPeso()+" Kg");

        altura.setText("Altura: "+personas.get(position).getAltura()+" Metros");
